                    ...
                    <div class="col-md-6" data-aos="flip-left">
                        <div className="card bg-dark">
                            <div class="card-body p-5 text-center">
                                ...
                                <div className='mt-4'>
                                    <a href='https://www.facebook.com/arip.ali.98' target="_blank" ><MdFacebook className='fs-1 text-danger me-2'/></a>
                                    <a href='https://www.linkedin.com/in/arif-ali-92a8b2229/' target="_blank" ><AiOutlineLinkedin className='fs-1 text-danger me-2'/></a>
                                    <a href='https://github.com/mdarifali' target="_blank"><AiOutlineGithub className='fs-1 text-danger'/></a>
                                </div>
                            </div>
                        </div>
                    </div>
